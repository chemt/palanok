	...
	build : function(user_options)
	{
		...
		return jQuery(this).each(
			function() {
				function LoadImages()
				{
					jQuery(this).bind("load", function()
					{
						...
						jQuery(this).hover(
							...
							function(){if(!jQuery(this).hasClass("pika_selected")){jQuery(this).fadeTo(250,0.7);}}
						);
				...
				prevHover.hide();
				nextHover.hide();
  				prevHover.fadeIn('slow');
   				nextHover.fadeIn('slow');	
			...
			function image_click(event, how){
					...
					if(image_source == main_img.attr("src"))
					{
						return;
					}
					...
					images.filter(".pika_selected").fadeTo(250,0.7); 
